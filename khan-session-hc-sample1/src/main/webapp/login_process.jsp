...
<%
    SessionLoginManager.getInstance().login(request, request.getParameter("USERID"));
...
%>
<h1>Login with '<%=SessionLoginManager.getInstance().loggedInUserId(request) %>'</h1>
<br>
<br>
<table border="1" cellspacing="0" cellpadding="3">
    ...
    <tr>
        ...
        <td class="row-left"><%=SessionLoginManager.getInstance().loggedInUserId(request) %></td>
    </tr>
